...
declare const agentEnvelopeStatuses: readonly ("streaming" | "draft" | "pending" | "waiting-approval" | "approved" | "rejected" | "executing" | "completed" | "partial" | "failed" | "cancelled" | "expired" | "superseded")[];
...
declare const agentEnvelopeContract: Readonly<{
    ...
    statuses: readonly ("streaming" | "draft" | "pending" | "waiting-approval" | "approved" | "rejected" | "executing" | "completed" | "partial" | "failed" | "cancelled" | "expired" | "superseded")[];
...
declare const uifContractRegistry: Readonly<{
    ...
    components: readonly UIFContractEntry<"button" | "modal" | "drawer" | "offcanvas" | "dropdown" | "tabs" | "toast" | "accordion" | "alert" | "badge" | "breadcrumb" | "collapse" | "tooltip" | "popover" | "progress" | "spinner" | "skeleton" | "pagination" | "command-menu" | "navbar" | "sidebar" | "stepper" | "wizard" | "file-upload" | "combobox" | "carousel" | "lightbox" | "masonry" | "card" | "table" | "form" | "editor" | "ajax" | "route" | "shell" | "nav" | "chart" | "animate" | "realtime" | "push" | "mobile-shell" | "desktop-shell" | "ai-action" | "ai-thread" | "ai-composer" | "agent-tool" | "tool-approval" | "typed-text" | "dashboard" | "install-prompt">[];
    actions: readonly UIFContractEntry<"toast" | "animate" | "close" | "copy" | "focus" | "load" | "reset" | "select" | "submit" | "toggle" | "add-class" | "remove-class" | "toggle-class" | "set-attribute" | "remove-attribute" | "set-value" | "scroll-to" | "emit" | "open" | "reject" | "toggle-sidebar" | "next" | "previous" | "toggle-section" | "reload" | "delete" | "save" | "clear" | "activate" | "deactivate" | "navigate" | "swap" | "append" | "prepend" | "remove" | "set-density" | "subscribe" | "connect" | "disconnect" | "approve" | "edit" | "install" | "preview" | "unsubscribe">[];
    states: readonly UIFContractEntry<"loading" | "error" | "success" | "online" | "offline" | "active" | "idle" | "open" | "pending" | "waiting-approval" | "approved" | "rejected" | "completed" | "failed" | "expired" | "loaded" | "empty" | "closed" | "expanded" | "collapsed" | "disabled" | "inactive" | "unavailable" | "selected" | "connected" | "disconnected" | "available" | "busy" | "connecting" | "decision-pending" | "dirty" | "installed" | "saved" | "saving" | "submitting">[];
    events: readonly UIFContractEntry<"uif:action-diagnostic" | "uif:ai-error" | "uif:agent:error" | "uif:ai-stream-cancel" | "uif:agent:feedback" | "uif:agent:submit" | "uif:agent:cancel" | "uif:ai-history-select" | "uif:chart-error" | "uif:chart-drilldown" | "uif:chart-drilldown-error" | "uif:chart-refresh" | "uif:chart-select" | "uif:chart-export" | "uif:init" | "uif:destroy" | "uif:toast" | "uif:shell-density" | "uif:select" | "uif:carousel-change" | "uif:lightbox-open" | "uif:before-init" | "uif:before-destroy" | "uif:error" | "uif:runtime:mounted" | "uif:runtime:error" | "uif:runtime:diagnostic" | "uif:diagnostic" | "uif:agent:retry" | "uif:agent:copy" | "uif:tool-approve" | "uif:tool-reject" | "uif:tool-expired" | "uif:tool-invalid-review" | "uif:tool-replay-blocked" | "uif:accordion-toggle" | "uif:ai-action" | "uif:animation-end" | "uif:animation-start" | "uif:before-load" | "uif:collapse-close" | "uif:collapse-open" | "uif:combobox-change" | "uif:command-menu-close" | "uif:command-menu-open" | "uif:complete" | "uif:connector-error" | "uif:dashboard-error" | "uif:desktop-change" | "uif:desktop-error" | "uif:drawer-close" | "uif:drawer-open" | "uif:dropdown-close" | "uif:dropdown-open" | "uif:editor-autosave" | "uif:editor-autosave-error" | "uif:editor-blur" | "uif:editor-change" | "uif:editor-command" | "uif:editor-destroy" | "uif:editor-diagnostics" | "uif:editor-error" | "uif:editor-focus" | "uif:editor-init" | "uif:editor-layout-change" | "uif:editor-mode-change" | "uif:editor-normalize" | "uif:editor-preview" | "uif:editor-reset" | "uif:editor-upload-error" | "uif:editor-validate" | "uif:field-errors" | "uif:file-select" | "uif:form-dirty" | "uif:form-error" | "uif:form-submit" | "uif:form-success" | "uif:form-touched" | "uif:lightbox-close" | "uif:load" | "uif:modal-close" | "uif:modal-open" | "uif:notification" | "uif:offcanvas-close" | "uif:offcanvas-open" | "uif:offline-error" | "uif:offline-expired" | "uif:offline-queued" | "uif:offline-synced" | "uif:pagination-change" | "uif:popover-close" | "uif:popover-open" | "uif:presence" | "uif:push-change" | "uif:push-error" | "uif:pwa-install" | "uif:rad-before" | "uif:rad-error" | "uif:rad-success" | "uif:realtime-error" | "uif:realtime-message" | "uif:realtime-state" | "uif:rehydrate" | "uif:request" | "uif:response" | "uif:route-before" | "uif:route-error" | "uif:route-success" | "uif:router-error" | "uif:segment-change" | "uif:table-before-load" | "uif:table-bulk-action" | "uif:table-error" | "uif:table-filter" | "uif:table-load" | "uif:table-loaded" | "uif:table-page" | "uif:table-page-size" | "uif:table-reset" | "uif:table-row-action" | "uif:table-select" | "uif:table-selection" | "uif:table-sort" | "uif:table-state" | "uif:tabs-change" | "uif:tool-confirmation-required" | "uif:typed-text-complete" | "uif:wizard-change">[];
    errors: readonly UIFContractEntry<"UIF_UNSAFE_PROPERTY_PATH" | "UIF_UNSAFE_OBJECT" | "UIF_COMPONENT_DESTROY" | "UIF_COMPONENT_DUPLICATE" | "UIF_COMPONENT_MOUNT" | "UIF_COMPONENT_NAME" | "UIF_INVALID_ACCENT" | "UIF_LOCALE_CONFIG" | "UIF_STORAGE_KEY" | "UIF_STORAGE_PARTITION">[];
}>;
...
declare const uifMigrationRules: readonly [{
    readonly id: "options-json";
    readonly introduced: "2.4.0";
    readonly strictIn: 3;
    readonly surface: "data-uif-options";
    readonly legacy: "Semicolon-delimited key:value options";
    readonly replacement: "A bounded JSON object using the component option schema";
    readonly diagnostic: "legacy-options";
}, {
    readonly id: "typed-text-json";
    readonly introduced: "2.6.0";
    readonly strictIn: 3;
    readonly surface: "data-uif-strings";
    readonly legacy: "Pipe-delimited phrase lists";
    readonly replacement: "A bounded JSON string array";
    readonly diagnostic: "legacy-typed-text-strings";
}, {
    readonly id: "cross-origin-capability";
    readonly introduced: "2.6.0";
    readonly strictIn: 3;
    readonly surface: "Remote URL options";
    readonly legacy: "Markup-only cross-origin allow flags";
    readonly replacement: "An application-registered exact origin/path capability plus explicit element intent";
    readonly diagnostic: "cross-origin-capability-required";
}, {
    readonly id: "partitioned-storage";
    readonly introduced: "2.6.0";
    readonly strictIn: 3;
    readonly surface: "Persisted browser convenience data";
    readonly legacy: "Unpartitioned global keys";
    readonly replacement: "configureStoragePartition() before persistence and owner-scoped cleanup at sign-out";
    readonly diagnostic: "storage-partition-recommended";
}, {
    readonly id: "agent-envelope-version";
    readonly introduced: "2.4.0";
    readonly strictIn: 3;
    readonly surface: "AI and MCP decisions";
    readonly legacy: "Unknown, incomplete, or unversioned decision envelopes";
    readonly replacement: "A governed Agent Interaction Envelope with supported version, request ID, expiry, and audit reference";
    readonly diagnostic: "agent-envelope-unavailable";
}];
...
declare const icons: {
    ...
    readonly facebook: {
        readonly body: "<path fill=\"currentColor\" stroke=\"none\" d=\"M13.8 21v-8h2.8l.4-3h-3.2V8.1c0-.9.3-1.5 1.6-1.5H17V3.9c-.7-.1-1.4-.2-2.1-.2-2.2 0-3.8 1.4-3.8 3.9V10H8.5v3h2.6v8h2.7z\"></path>";
    };
    readonly github: {
        readonly body: "<circle cx=\"12\" cy=\"12\" r=\"9\"></circle><path d=\"M8.5 19.5v-2.2c-2.8.6-3.4-1.2-3.4-1.2-.5-1.2-1.1-1.5-1.1-1.5\"></path><path d=\"M15.5 19.5v-2.7c0-.8-.3-1.4-.8-1.8 2.6-.3 5.3-1.3 5.3-5.7 0-1.3-.5-2.3-1.2-3.2.1-.3.5-1.6-.1-3.1 0 0-1-.3-3.3 1.2a11.7 11.7 0 0 0-6 0C7.1 2.7 6.1 3 6.1 3c-.6 1.5-.2 2.8-.1 3.1a4.6 4.6 0 0 0-1.2 3.2c0 4.4 2.7 5.4 5.3 5.7-.4.3-.7.8-.8 1.4\"></path>";
    };
    readonly instagram: {
        readonly body: "<rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"5\"></rect><circle cx=\"12\" cy=\"12\" r=\"4\"></circle><circle cx=\"17.4\" cy=\"6.6\" r=\"1\" fill=\"currentColor\" stroke=\"none\"></circle>";
    };
    readonly linkedin: {
        readonly body: "<rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"2\"></rect><circle cx=\"7.2\" cy=\"8\" r=\"1\" fill=\"currentColor\" stroke=\"none\"></circle><path d=\"M7.2 10.5v6.3M11 16.8v-6.3M11 13.2c.4-1.7 4.8-2.3 4.8 1.2v2.4\"></path>";
    };
    readonly uif: {
    ...
    readonly 'x-twitter': {
        readonly body: "<path d=\"M4 4l16 16M20 4 9.2 14.8M4 20l6.1-6.1\"></path>";
    };
    readonly youtube: {
        readonly body: "<rect x=\"2.5\" y=\"5\" width=\"19\" height=\"14\" rx=\"4\"></rect><path d=\"m10 9 5 3-5 3V9z\" fill=\"currentColor\" stroke=\"none\"></path>";
    };
};
