...
var BatoiUIF = (() => {
  ...
  __export(index_exports, {
    ...
    applyPermissionNavigation: () => applyPermissionNavigation,
    ...
    bindDesktopOfflineIndicator: () => bindDesktopOfflineIndicator,
    bindDesktopSettings: () => bindDesktopSettings,
    ...
    createDesktopManifest: () => createDesktopManifest,
    createDesktopShell: () => createDesktopShell,
    createDesktopSyncStatus: () => createDesktopSyncStatus,
    createEditor: () => createEditor,
    createExtensionManifest: () => createExtensionManifest,
    createExtensionMessage: () => createExtensionMessage,
    createLocalSettingsStore: () => createLocalSettingsStore,
    createLocalStore: () => createLocalStore,
    createMemorySettingsStore: () => createMemorySettingsStore,
    ...
    hasDesktopCapability: () => hasDesktopCapability,
    hasIcon: () => hasIcon,
    hide: () => hide2,
    ...
    parseDesktopManifestElement: () => parseDesktopManifestElement,
    parseMicroAppManifest: () => parseMicroAppManifest,
    parseOptions: () => parseOptions2,
    percentChange: () => percentChange,
    popover: () => popover,
    positionOverlay: () => positionOverlay2,
    post: () => post,
    progress: () => progress,
    publishBatched: () => publishBatched,
    ...
    renderDesktopShell: () => renderDesktopShell,
    renderDesktopSyncStatus: () => renderDesktopSyncStatus,
    renderDiff: () => renderDiff,
    renderPromptPanel: () => renderPromptPanel,
    renderToolApproval: () => renderToolApproval,
    renderToolAuditTrail: () => renderToolAuditTrail,
    renderToolProgress: () => renderToolProgress,
    renderToolResult: () => renderToolResult,
    renderToolTimeline: () => renderToolTimeline,
    renderWorkspaceIdentity: () => renderWorkspaceIdentity,
    request: () => request2,
    ...
    setDesktopStatus: () => setDesktopStatus,
    setEditorPreviewLayout: () => setEditorPreviewLayout,
    ...
    summarizeDesktopQueue: () => summarizeDesktopQueue,
