...
export { type IconDefinition, type IconName, type IconOptions, type IconRegistry, type MountIconsOptions, hasIcon, icon, iconElement, icons, mountIcons, registerIcon };
