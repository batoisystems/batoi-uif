...
export { type HTMLSwapMode, type SafeHTMLRenderOptions, type TrustedHTMLRenderOptions, type UIFDomComponent, appendTextElement, autoInit, closest, isInitialized, mount, observe, qs, qsa, registerComponent, resolveTarget, sanitizeHTML, setSafeHTML, setText, setTrustedHTML, swapTrustedHTML, unmount };
