...
Framework 2.5.0; contract version 3. This file is generated from typed source definitions.
...
| `tool-approval` | `@batoi/uif-mcp` | registry | Review summary with explicit decision controls | approve, reject | uif:tool-approve, uif:tool-expired, uif:tool-reject | approved, decision-pending, expired, rejected, waiting-approval | UIF_COMPONENT_MOUNT |
